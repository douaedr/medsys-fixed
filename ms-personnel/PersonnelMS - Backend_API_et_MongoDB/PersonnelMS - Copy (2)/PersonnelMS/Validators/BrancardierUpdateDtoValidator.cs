...
{
    public class BrancardierUpdateDtoValidator : AbstractValidator<BrancardierUpdateDto>
    {
        public BrancardierUpdateDtoValidator()
        {
            ...
            RuleFor(x => x.ZoneCouverture).NotEmpty();
        }
    }
}